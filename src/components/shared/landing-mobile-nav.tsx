...
export function LandingMobileNav() {
  ...
  return (
    <>
      ...
      >
        {/* Decorative gradient */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_50%_50%_at_50%_30%,rgba(245,158,11,0.08),transparent)]" />
        ...
        <div className="relative h-full flex flex-col items-center justify-center px-8">
          ...
          <nav className="flex flex-col items-center gap-2 mb-12">
            {links.map((link, i) => (
              <Link
                ...
                className={`text-3xl sm:text-4xl font-bold text-white/80 hover:text-amber-400 transition-all duration-500 py-2 ${
          ...
          >
            ...
            <Link href="#contact" onClick={() => setOpen(false)}>
              <Button className="bg-amber-500 hover:bg-amber-400 text-black font-bold text-lg px-8 py-6 h-auto">
                {t('nav.bookCall')}
